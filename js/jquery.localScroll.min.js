! function(e) {
    ...
    function t(t, n, o) {
        ...
        if (a) {
            t && t.preventDefault();
            var l = e(o.target);
            if (!(o.lock && l.is(":animated") || o.onBefore && !1 === o.onBefore(t, a, l))) {
    ...
    return o.defaults = {
        ...
        return (i = e.extend({}, o.defaults, i)).hash && location.hash && (i.target && window.scrollTo(0, 0), t(0, location, i)), i.lazy ? this.on(i.event, "a,area", function(e) {
