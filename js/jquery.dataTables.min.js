! function(t) {
    ...
    function o(e, n, i) {
        ...
        t.each(n, function(r, l) {
            (s = e._hungarianMap[r]) === a || !i && n[s] !== a || ("o" === s.charAt(0) ? (n[s] || (n[s] = {}), t.extend(!0, n[s], n[r]), o(e[s], n[s], i)) : n[s] = n[r])
        })
    }
    ...
    function s(t) {
        ...
        if (e)
            for (var n = 0, a = e.length; n < a; n++) e[n] && o($t.models.oSearch, e[n])
    }
    ...
    function S(t) {
        ...
        for (e = 0, n = f.length; e < n; e++)
            ...
            for (r = 0, o = h.length; r < o; r++) {
                for (i = 0, s = d.length; i < s && (c[i] === a && (c[i] = w(t, i, e, "type")), (u = h[r](c[i], t)) || r === h.length - 1) && "html" !== u; i++);
                if (u) {
                    l.sType = u;
                    break
                }
        ...
        if (n)
            for (i = n.length - 1; i >= 0; i--) {
                ...
                for (t.isArray(g) || (g = [g]), l = 0, u = g.length; l < u; l++)
                    ...
                    for (c = 0, d = p.length; c < d; c++)("_all" == g[l] || t(p[c].nTh).hasClass(g[l])) && o(c, h)
            }
        if (r)
            for (i = 0, s = r.length; i < s; i++) o(i, r[i])
    }
                ...
                for (var c = x(o), f = 0, d = c.length; f < d; f++) {
                    if (i = c[f].match(ge), s = c[f].match(be), i) {
                        if (c[f] = c[f].replace(ge, ""), "" !== c[f] && (e = e[c[f]]), l = [], c.splice(0, f + 1), u = c.join("."), t.isArray(e))
                            for (var h = 0, p = e.length; h < p; h++) l.push(r(e[h], n, u));
        ...
        var n = function(e, r, o) {
            for (var i, s, l, u, c, f = x(o), d = f[f.length - 1], h = 0, p = f.length - 1; h < p; h++) {
                if (s = f[h].match(ge), l = f[h].match(be), s) {
                    if (f[h] = f[h].replace(ge, ""), e[f[h]] = [], (i = f.slice()).splice(0, h + 1), c = i.join("."), t.isArray(r))
        ...
        var p = function(t, e) {
                if ("string" == typeof t) {
                    ...
                    if (-1 !== n) {
                        ...
                        A(t)(o, e.getAttribute(a))
                    }
                }
            },
            g = function(e) {
                r !== a && r !== f || (s = d[f], l = t.trim(e.innerHTML), s && s._bAttrSrc ? (A(s.mData._)(o, l), p(s.mData.sort, e), p(s.mData.type, e), p(s.mData.filter, e)) : h ? (s._setter || (s._setter = A(s.mData)), s._setter(o, l)) : o[f] = l), f++
            };
        if (c)
    ...
    function H(e, a, r, o) {
        var i, s, l, u, c, f = e.aoData[a],
            ...
            h = [];
        if (null === f.nTr) {
            for (i = r || n.createElement("tr"), f.nTr = i, f.anCells = h, i._DT_RowIndex = a, N(e, f), u = 0, c = e.aoColumns.length; u < c; u++) l = e.aoColumns[u], (s = r ? o[u] : n.createElement(l.sCellType))._DT_CellIndex = {
                row: a,
                column: u
            }, h.push(s), r && !l.mRender && l.mData === u || t.isPlainObject(l.mData) && l.mData._ === u + ".display" || (s.innerHTML = w(e, a, u, "display")), l.sClass && (s.className += " " + l.sClass), l.bVisible && !r ? i.appendChild(s) : !l.bVisible && r && s.parentNode.removeChild(s), l.fnCreatedCell && l.fnCreatedCell.call(e.oInstance, s, w(e, a, u), d, a, u);
    ...
    function O(e) {
        var n, a, r, o, i, s = e.nTHead,
            ...
            c = e.oClasses,
            f = e.aoColumns;
        for (u && (o = t("<tr/>").appendTo(s)), n = 0, a = f.length; n < a; n++) i = f[n], r = t(i.nTh).addClass(i.sClass), u && r.appendTo(o), e.oFeatures.bSort && (r.addClass(i.sSortingClass), !1 !== i.bSortable && (r.attr("tabindex", e.iTabIndex).attr("aria-controls", e.sTableId), xt(e, i.nTh, n))), i.sTitle != r[0].innerHTML && r.html(i.sTitle), Wt(e, "header")(e, r, i, c);
    ...
    function M(e) {
        ...
        if (-1 === t.inArray(!1, n)) {
            ...
            var T = t(e.nTBody);
            T.children().detach(), T.append(t(r)), kt(e, "aoDrawCallback", "draw", [e]), e.bSorted = !1, e.bFiltered = !1, e.bDrawing = !1
        } else ht(e, !1)
    }
    ...
    function W(t, e) {
        var n = t.oFeatures,
            a = n.bSort,
            r = n.bFilter;
        a && Tt(t), r ? z(t, t.oPreviousSearch) : t.aiDisplay = t.aiDisplayMaster.slice(), !0 !== e && (t._iDisplayStart = 0), t._drawHold = e, M(t), t._drawHold = !1
    }
    ...
    function U(e) {
        ...
        for (var s, l, u, c, f, d, h = e.sDom.split(""), p = 0; p < h.length; p++) {
            if (s = null, "<" == (l = h[p])) {
                ...
                for (var b = $t.ext.feature, v = 0, S = b.length; v < S; v++)
                    if (l == b[v].cFeature) {
                        s = b[v].fnInit(e);
                        break
                    }
            ...
            for (c = 0, r = (a = p[o]).firstChild; r;) {
                if ("TD" == r.nodeName.toUpperCase() || "TH" == r.nodeName.toUpperCase())
                    for (f = 1 * r.getAttribute("colspan"), d = 1 * r.getAttribute("rowspan"), f = f && 0 !== f && 1 !== f ? f : 1, d = d && 0 !== d && 1 !== d ? d : 1, u = function(t, e, n) {
                            for (var a = t[e]; a[n];) n++;
                            return n
                        }(e, o, c), h = 1 === f, s = 0; s < f; s++)
                        for (i = 0; i < d; i++) e[o + i][u + s] = {
                            cell: r,
                            unique: h
                        }, e[o + i].nTr = a;
                r = r.nextSibling
    ...
    function E(t, e, n) {
        ...
        for (var r = 0, o = n.length; r < o; r++)
            for (var i = 0, s = n[r].length; i < s; i++) !n[r][i].unique || a[i] && t.bSortCellsTop || (a[i] = n[r][i].cell);
        return a
    }
    ...
    function J(e, n, a) {
        ...
        var f = {
            ...
            error: function(n, a, r) {
                var o = kt(e, null, "xhr", [e, null, e.jqXHR]); - 1 === t.inArray(!0, o) && ("parsererror" == a ? Rt(e, 0, "Invalid JSON response", 1) : 4 === n.readyState && Rt(e, 0, "Ajax error", 7)), ht(e, !1)
            }
        };
    ...
    function X(e) {
        var n, a, r, o, i = e.aoColumns,
            ...
            d = _t(e),
            h = e._iDisplayStart,
            p = !1 !== l.bPaginate ? e._iDisplayLength : -1,
            g = function(t, e) {
                f.push({
                    name: t,
                    value: e
        ...
        for (n = 0; n < s; n++) r = i[n], o = c[n], a = "function" == typeof r.mData ? "function" : r.mData, b.columns.push({
            data: a,
            name: r.sName,
    ...
    function q(t, e) {
        ...
        for (var l = 0, u = r.length; l < u; l++) D(t, r[l]);
    ...
    function Y(e) {
        for (var n, a, r = $t.ext.search, o = e.aiDisplay, i = 0, s = r.length; i < s; i++) {
            for (var l = [], u = 0, c = o.length; u < c; u++) a = o[u], n = e.aoData[a], r[i](e, n._aFilterData, a, n._aData, u) && l.push(a);
    ...
    function Q(t, e, n, a, r, o) {
        ...
        if (0 !== $t.ext.search.length && (n = !0), s = tt(t), e.length <= 0) t.aiDisplay = f.slice();
            ...
            for ((s || n || c.length > e.length || 0 !== e.indexOf(c) || t.bSorted) && (t.aiDisplay = f.slice()), l = (i = t.aiDisplay).length - 1; l >= 0; l--) u.test(t.aoData[i[l]]._sFilterRow) || i.splice(l, 1)
    }

    function K(e, n, a, r) {
        return e = n ? e : ve(e), a && (e = "^(?=.*?" + t.map(e.match(/"[^"]+"|[^ ]+/g) || [""], function(t) {
            if ('"' === t.charAt(0)) {
                var e = t.match(/^"(.*)"$/);
                t = e ? e[1] : t
            }
    ...
    function tt(t) {
        ...
        for (n = 0, r = t.aoData.length; n < r; n++)
            if (!(l = t.aoData[n])._aFilterData) {
                for (i = [], a = 0, o = u.length; a < o; a++)(e = u[a]).bSearchable ? (s = w(t, n, a, "filter"), c[e.sType] && (s = c[e.sType](s)), null === s && (s = ""), "string" != typeof s && s.toString && (s = s.toString())) : s = "", s.indexOf && -1 !== s.indexOf("&") && (Se.innerHTML = s, s = me ? Se.textContent : Se.innerText), s.replace && (s = s.replace(/[\r\n]/g, "")), i.push(s);
    ...
    function rt(e) {
        ...
        if (0 !== n.length) {
            ...
            s !== i && (l += " " + a.sInfoFiltered), l = ot(e, l += a.sInfoPostFix);
    ...
    function it(t) {
        var e, n, a, r = t.iInitDisplayStart,
            ...
            s = t.bDeferLoading;
        if (t.bInitialised) {
            for (U(t), O(t), k(t, t.aoHeader), k(t, t.aoFooter), ht(t, !0), i.bAutoWidth && vt(t), e = 0, n = o.length; e < n; e++)(a = o[e]).sWidth && (a.nTh.style.width = yt(a.sWidth));
    ...
    function ut(e) {
        for (var n = e.oClasses, a = e.sTableId, r = e.aLengthMenu, o = t.isArray(r[0]), i = o ? r[0] : r, s = o ? r[1] : r, l = t("<select/>", {
            ...
            }), u = 0, c = i.length; u < c; u++) l[0][u] = new Option(s[u], i[u]);
            ...
            fn: function(t) {
                if (r) {
                    var e, n, i = t._iDisplayStart,
                        ...
                        d = c ? 1 : Math.ceil(u / l),
                        h = a(f, d);
                    for (e = 0, n = s.p.length; e < n; e++) Wt(t, "pageButton")(t, s.p[e], e, h, f, d)
                } else a.fnUpdate(t, o)
            },
            sName: "pagination"
        })), i
    ...
    function ft(t, e, n) {
        var a = t._iDisplayStart,
            r = t._iDisplayLength,
            o = t.fnRecordsDisplay();
        0 === o || -1 === r ? a = 0 : "number" == typeof e ? (a = e * r) > o && (a = 0) : "first" == e ? a = 0 : "previous" == e ? (a = r >= 0 ? a - r : 0) < 0 && (a = 0) : "next" == e ? a + r < o && (a += r) : "last" == e ? a = Math.floor((o - 1) / r) * r : Rt(t, 0, "Unknown paging action: " + e, 5);
    ...
    function gt(e) {
        var n, r, o, i, s, l, u, c, f, d = e.oScroll,
            ...
            J = w.scrollHeight > w.clientHeight;
        if (e.scrollBarVis !== J && e.scrollBarVis !== a) return e.scrollBarVis = J, void h(e);
        e.scrollBarVis = J, L.children("thead, tfoot").remove(), j && (l = j.clone().prependTo(L), r = j.find("tr"), i = l.find("tr")), s = F.clone().prependTo(L), n = F.find("tr"), o = s.find("tr"), s.find("th, td").removeAttr("tabindex"), g || (x.width = "100%", m[0].style.width = "100%"), t.each(E(e, s), function(t, n) {
            u = p(e, t), n.style.width = e.aoColumns[u].sWidth
        }), j && bt(function(t) {
            t.style.width = ""
        }, i), f = L.outerWidth(), "" === g ? (R.width = "100%", N && (L.find("tbody").height() > w.offsetHeight || "scroll" == C.css("overflow-y")) && (R.width = yt(L.outerWidth() - S)), f = L.outerWidth()) : "" !== b && (R.width = yt(b), f = L.outerWidth()), bt(B, o), bt(function(e) {
            W.push(e.innerHTML), k.push(yt(t(e).css("width")))
        }, o), bt(function(e, n) {
            -1 !== t.inArray(e, O) && (e.style.width = k[n])
        }, n), t(o).height(0), j && (bt(B, i), bt(function(e) {
        ...
        }, i), L.outerWidth() < f ? (c = w.scrollHeight > w.offsetHeight || "scroll" == C.css("overflow-y") ? f + S : f, N && (w.scrollHeight > w.offsetHeight || "scroll" == C.css("overflow-y")) && (R.width = yt(c - S)), "" !== g && "" === b || Rt(e, 1, "Possible column misalignment", 6)) : c = "100%", x.width = yt(c), D.width = yt(c), j && (e.nScrollFoot.style.width = yt(c)), v || N && (x.height = yt(P.offsetHeight + S));
        var V = L.outerWidth();
        T[0].style.width = yt(V), _.width = yt(V);
        var X = L.height() > w.clientHeight || "scroll" == C.css("overflow-y"),
            q = "padding" + (H.bScrollbarLeft ? "Left" : "Right");
        _[q] = X ? S + "px" : "0px", j && (A[0].style.width = yt(V), I[0].style.width = yt(V), I[0].style[q] = X ? S + "px" : "0px"), L.children("colgroup").insertBefore(L.children("thead")), C.scroll(), !e.bSorted && !e.bFiltered || e._drawHold || (w.scrollTop = 0)
    }
    ...
    function vt(n) {
        var a, r, o, i = n.nTable,
            ...
            T = _.bScrollOversize,
            w = i.style.width;
        for (w && -1 !== w.indexOf("%") && (m = w), a = 0; a < g.length; a++) null !== (r = s[g[a]]).sWidth && (r.sWidth = St(r.sWidthOrig, D), y = !0);
        if (T || !y && !c && !u && d == b(n) && d == S.length)
            for (a = 0; a < d; a++) {
                var C = p(n, a);
                null !== C && (s[C].sWidth = yt(S.eq(a).width()))
            } else {
                ...
                if (n.aoData.length)
                    for (a = 0; a < g.length; a++) r = s[o = g[a]], t(mt(n, o)).clone(!1).append(r.sContentPadding).appendTo(I);
        ...
        if (m && (i.style.width = yt(m)), (m || c) && !n._reszEvt) {
            ...
            T ? setTimeout(j, 1e3) : j(), n._reszEvt = !0
        }
    }
    ...
    function mt(e, n) {
        ...
        if (a < 0) return null;
        var r = e.aoData[a];
        return r.nTr ? r.anCells[n] : t("<td/>").html(w(e, a, n, "display"))[0]
    }

    function Dt(t, e) {
        for (var n, a = -1, r = -1, o = 0, i = t.aoData.length; o < i; o++)(n = (n = (n = w(t, o, e, "display") + "").replace(De, "")).replace(/&nbsp;/g, " ")).length > a && (a = n.length, r = o);
        return r
    }
    ...
    function _t(e) {
        ...
        for (t.isArray(d) && g(d), h && d.pre && g(d.pre), g(e.aaSorting), h && d.post && g(d.post), n = 0; n < p.length; n++)
            for (r = 0, o = (i = f[u = p[n][0]].aDataSort).length; r < o; r++) l = f[s = i[r]].sType || "string", p[n]._idx === a && (p[n]._idx = t.inArray(p[n][1], f[s].asSorting)), c.push({
                src: u,
                col: s,
                dir: p[n][1],
                index: p[n]._idx,
    ...
    function Tt(t) {
        var e, n, a, r, o, i = [],
            ...
            u = (t.aoColumns, 0),
            c = t.aiDisplayMaster;
        for (S(t), e = 0, n = (o = _t(t)).length; e < n; e++)(r = o[e]).formatter && u++, At(t, r.col);
        if ("ssp" != Ut(t) && 0 !== o.length) {
            ...
            u === o.length ? c.sort(function(t, e) {
                var n, a, r, s, u, c = o.length,
                    ...
                    d = l[e]._aSortData;
                for (r = 0; r < c; r++)
                    if (u = o[r], n = f[u.col], a = d[u.col], 0 !== (s = n < a ? -1 : n > a ? 1 : 0)) return "asc" === u.dir ? s : -s;
                ...
                var n, a, r, u, c, f, d = o.length,
                    ...
                    p = l[e]._aSortData;
                for (r = 0; r < d; r++)
                    if (c = o[r], n = h[c.col], a = p[c.col], f = s[c.type + "-" + c.dir] || s["string-" + c.dir], 0 !== (u = f(n, a))) return u;
                return n = i[t], a = i[e], n < a ? -1 : n > a ? 1 : 0
            })
        }
        t.bSorted = !0
    ...
    function wt(t) {
        for (var e, n, a = t.aoColumns, r = _t(t), o = t.oLanguage.oAria, i = 0, s = a.length; i < s; i++) {
            var l = a[i],
                u = l.asSorting,
    ...
    function Ct(e, n, r, o) {
        ...
        if ("number" == typeof l[0] && (l = e.aaSorting = [l]), r && e.oFeatures.bSortMulti) {
            var f = t.inArray(n, le(l, "0")); - 1 !== f ? (null === (i = c(l[f], !0)) && 1 === l.length && (i = 0), null === i ? l.splice(f, 1) : (l[f][1] = u[i], l[f]._idx = i)) : (l.push([n, u[0], 0]), l[l.length - 1]._idx = 0)
    ...
    function xt(t, e, n, a) {
        var r = t.aoColumns[n];
        Nt(e, {}, function(e) {
            !1 !== r.bSortable && (t.oFeatures.bProcessing ? (ht(t, !0), setTimeout(function() {
                Ct(t, n, e.shiftKey, a), "ssp" !== Ut(t) && ht(t, !1)
    ...
    function It(e) {
        ...
        if (l.bSort && l.bSortClasses) {
            for (n = 0, a = o.length; n < a; n++) r = o[n].src, t(le(e.aoData, "anCells", r)).removeClass(i + (n < 2 ? n + 1 : 3));
            for (n = 0, a = s.length; n < a; n++) r = s[n].src, t(le(e.aoData, "anCells", r)).addClass(i + (n < 2 ? n + 1 : 3))
        }
        e.aLastSort = s
    }
    ...
    function At(t, e) {
        ...
        for (var o, i, s = $t.ext.type.order[a.sType + "-pre"], l = 0, u = t.aoData.length; l < u; l++)(o = t.aoData[l])._aSortData || (o._aSortData = []), o._aSortData[e] && !r || (i = r ? n[l] : w(t, l, e, "sort"), o._aSortData[e] = s ? s(i) : i)
    }
    ...
    function Lt(e, n) {
        ...
        if (e.oFeatures.bStateSave) {
            ...
            if (s && s.time) {
                var l = kt(e, "aoStateLoadParams", "stateLoadParams", [e, s]);
                if (-1 === t.inArray(!1, l)) {
                    ...
                    if (!(u > 0 && s.time < +new Date - 1e3 * u) && i.length === s.columns.length) {
                        for (e.oLoadedState = t.extend(!0, {}, s), s.start !== a && (e._iDisplayStart = s.start, e.iInitDisplayStart = s.start), s.length !== a && (e._iDisplayLength = s.length), s.order !== a && (e.aaSorting = [], t.each(s.order, function(t, n) {
                            ...
                            })), s.search !== a && t.extend(e.oPreviousSearch, nt(s.search)), r = 0, o = s.columns.length; r < o; r++) {
                            var c = s.columns[r];
                            c.visible !== a && (i[r].bVisible = c.visible), c.search !== a && t.extend(e.aoPreSearchCols[r], nt(c.search))
                        }
                        kt(e, "aoStateLoaded", "stateLoaded", [e, s])
                    }
                }
            }
        }
    ...
    function Bt(t, e) {
        var n = [],
            a = Be.numbers_length,
            r = Math.floor(a / 2);
        return e <= a ? n = ce(0, e) : t <= r ? ((n = ce(0, a - 2)).push("ellipsis"), n.push(e - 1)) : t >= e - 1 - r ? ((n = ce(e - (a - 2), e)).splice(0, 0, "ellipsis"), n.splice(0, 0, 0)) : ((n = ce(t - r + 2, t + r - 1)).push("ellipsis"), n.push(e - 1), n.splice(0, 0, "ellipsis"), n.splice(0, 0, 0)), n.DT_el = "span", n
    }
    ...
    var Vt, Xt, qt, Gt, $t = function(e) {
            ...
            return this.each(function() {
                ...
                if ("table" == this.nodeName.toLowerCase()) {
                    s(_), l(_.column), o(_, _, !0), o(_.column, _.column, !0), o(_, t.extend(g, T.data()));
                    var w = $t.settings;
                    for (b = 0, h = w.length; b < h; b++) {
                        var C = w[b];
                    ...
                    var L = F.oClasses;
                    if (g.bJQueryUI ? (t.extend(L, $t.ext.oJUIClasses, g.oClasses), g.sDom === _.sDom && "lfrtip" === _.sDom && (F.sDom = '<"H"lfr>t<"F"ip>'), F.renderer ? t.isPlainObject(F.renderer) && !F.renderer.header && (F.renderer.header = "jqueryui") : F.renderer = "jqueryui") : t.extend(L, $t.ext.classes, g.oClasses), T.addClass(L.sTable), F.iInitDisplayStart === a && (F.iInitDisplayStart = g.iDisplayStart, F._iDisplayStart = g.iDisplayStart), null !== g.iDeferLoading) {
                        F.bDeferLoading = !0;
                    ...
                    var j = F.asStripeClasses,
                        H = T.children("tbody").find("tr").eq(0); - 1 !== t.inArray(!0, t.map(j, function(t, e) {
                        return H.hasClass(t)
                    ...
                    if (g.bStateSave && (W.bStateSave = !0, Lt(F, g), Ot(F, "aoDrawCallback", Ft, "state_save")), g.aaSorting === a) {
                        var U = F.aaSorting;
                        for (b = 0, h = U.length; b < h; b++) U[b][1] = F.aoColumns[b].asSorting[0]
                    }
                    ...
                    var X = T.children("tbody");
                    0 === X.length && (X = t("<tbody/>").appendTo(this)), F.nTBody = X[0];
                    var q = T.children("tfoot");
                    if (0 === q.length && J.length > 0 && ("" !== F.oScroll.sX || "" !== F.oScroll.sY) && (q = t("<tfoot/>").appendTo(this)), 0 === q.length || 0 === q.children().length ? T.addClass(L.sNoFooter) : q.length > 0 && (F.nTFoot = q[0], B(F.aoFooter, F.nTFoot)), g.aaData)
                        for (b = 0; b < g.aaData.length; b++) D(F, g.aaData[b]);
                    else(F.bDeferLoading || "dom" == Ut(F)) && y(F, t(F.nTBody).children("tr"));
                    F.aiDisplay = F.aiDisplayMaster.slice(), F.bInitialised = !0, !1 === S && it(F)
                } else Rt(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2)
            }), n = null, this
        },
        zt = {},
        Yt = /[\r\n]/g,
        ...
        oe = function(t, e, n) {
            ...
            return !!ne(t) || (e && a && (t = re(t, e)), n && a && (t = t.replace(ee, "")), !isNaN(parseFloat(t)) && isFinite(t))
        },
        ie = function(t) {
            return ne(t) || "string" == typeof t
        },
        se = function(t, e, n) {
            return !!ne(t) || (ie(t) ? !!oe(de(t), e, n) || null : null)
        },
        le = function(t, e, n) {
            var r = [],
                o = 0,
        ...
        ue = function(t, e, n, r) {
            var o = [],
                ...
                s = e.length;
            if (r !== a)
                for (; i < s; i++) t[e[i]][n] && o.push(t[e[i]][n][r]);
            else
                for (; i < s; i++) o.push(t[e[i]][n]);
            return o
        },
        ce = function(t, e) {
            var n, r = [];
    ...
    Xt = function(e, n) {
        ...
        iterator: function(t, e, n, r) {
            ...
            for ("string" == typeof t && (r = n, n = e, e = t, t = !1), i = 0, s = p.length; i < s; i++) {
                ...
                if ("table" === e)(o = n.call(b, p[i], i)) !== a && h.push(o);
                    ...
                    for (f = this[i], "column-rows" === e && (c = Le(p[i], g.opts)), l = 0, u = f.length; l < u; l++) d = f[l], (o = "cell" === e ? n.call(b, p[i], d.row, d.column, i, l) : n.call(b, p[i], d, i, l, c)) !== a && h.push(o)
            }
            if (h.length || r) {
        ...
        if (a.length && n && (n instanceof Xt || n.__dt_wrapper)) {
            ...
            }(e, i.val, i) : t.isPlainObject(i.val) ? {} : i.val, n[i.name].__dt_wrapper = !0, Xt.extend(e, n[i.name], i.propExt)
        }
    }, Xt.register = qt = function(e, n) {
        if (t.isArray(e))
            for (var a = 0, r = e.length; a < r; a++) Xt.register(e[a], n);
        else {
            ...
            for (o = 0, i = u.length; o < i; o++) {
                var f = function(t, e) {
                    ...
                    return null
                }(c, s = (l = -1 !== u[o].indexOf("()")) ? u[o].replace("()", "") : u[o]);
                f || (f = {
                    name: s,
                    val: {},
                    methodExt: [],
    ...
    qt("tables()", function(t) {
        return t ? new Xt(Ce(t, this.context)) : this
    }), qt("table()", function(t) {
        var e = this.tables(t),
            n = e.context;
        ...
        return this.iterator("table", function(e) {
            "page" === t ? M(e) : ("string" == typeof t && (t = "full-hold" !== t), W(e, !1 === t))
        })
    }), qt("page()", function(t) {
    ...
    var xe = function(t, e, n) {
        ...
        if ("ssp" == Ut(t)) W(t, e);
            ...
            r && 4 !== r.readyState && r.abort(), J(t, [], function(n) {
                L(t);
                for (var a = G(t, n), r = 0, o = a.length; r < o; r++) D(t, a[r]);
                W(t, e), ht(t, !1)
            })
        }
    };
    ...
    var Ie = function(e, n, r, o, i) {
            ...
            for (n && "string" !== p && "function" !== p && n.length !== a || (n = [n]), u = 0, c = n.length; u < c; u++)
                for (f = 0, d = (l = n[u] && n[u].split ? n[u].split(",") : [n[u]]).length; f < d; f++)(s = r("string" == typeof l[f] ? t.trim(l[f]) : l[f])) && s.length && (h = h.concat(s));
            var g = Vt.selector[e];
            if (g.length)
        ...
        Le = function(e, n) {
            ...
            if ("current" == f)
                for (a = e._iDisplayStart, r = e.fnDisplayEnd(); a < r; a++) i.push(s[a]);
            else if ("current" == c || "applied" == c) i = "none" == u ? l.slice() : "applied" == u ? s.slice() : t.map(l, function(e, n) {
                return -1 === t.inArray(e, s) ? e : null
            });
            else if ("index" == c || "original" == c)
                for (a = 0, r = e.aoData.length; a < r; a++) "none" == u ? i.push(a) : (-1 === (o = t.inArray(a, s)) && "removed" == u || o >= 0 && "applied" == u) && i.push(a);
            return i
        },
        Pe = function(e, n, r) {
            return Ie("row", n, function(n) {
                var o = ae(n);
    ...
    var Re = function(e, n, a, r) {
            var o = [],
                i = function(n, a) {
                    if (t.isArray(n) || n instanceof t)
                        for (var r = 0, s = n.length; r < s; r++) i(n[r], a);
        ...
        Ne = function(t) {
            var e = new Xt(t),
                n = t.aoData;
            e.off("draw.dt.DT_details column-visibility.dt.DT_details destroy.dt.DT_details"), le(n, "_details").length > 0 && (e.on("draw.dt.DT_details", function(a, r) {
                t === r && e.rows({
                    page: "current"
                ...
                if (t === a)
                    for (var i, s = b(a), l = 0, u = n.length; l < u; l++)(i = n[l])._details && i._details.children("td[colspan]").attr("colspan", s)
            }), e.on("destroy.dt.DT_details", function(a, r) {
                if (t === r)
                    for (var o = 0, i = n.length; o < i; o++) n[o]._details && je(e, o)
            }))
        };
    qt("row().child()", function(t, e) {
        var n = this.context;
        return t === a ? n.length && this.length ? n[0].aoData[this[0]]._details : a : (!0 === t ? this.child.show() : !1 === t ? je(this) : n.length && this.length && Re(n[0], n[0].aoData[this[0]], t, e), this)
    ...
    var Oe = /^(.+):(name|visIdx|visible)$/,
        ke = function(t, e, n, a, r) {
            for (var o = [], i = 0, s = r.length; i < s; i++) o.push(w(t, r[i], e));
            return o
        },
        Me = function(e, n, a) {
            var r = e.aoColumns,
            ...
            return Ie("column", n, function(n) {
                ...
                if ("function" == typeof n) {
                    ...
                    return t.map(r, function(t, a) {
                        return n(a, ke(e, a, 0, 0, l), i[a]) ? a : null
                    })
                }
    ...
    var Ue = function(e, n, r) {
        var o, i, s, l, u, c, f, d = e.aoData,
            ...
            g = t([].concat.apply([], p)),
            b = e.aoColumns.length;
        return Ie("cell", n, function(n) {
            var r = "function" == typeof n;
            if (null === n || n === a || r) {
                for (i = [], s = 0, l = h.length; s < l; s++)
                    for (o = h[s], u = 0; u < b; u++) c = {
                        row: o,
                        column: u
                    }, r ? (f = d[o], n(c, w(e, o, u), f.anCells ? f.anCells[u] : null) && i.push(c)) : i.push(c);
                return i
            }
    ...
    qt("cells()", function(e, n, r) {
            ...
            var e = this.context,
                n = this[0];
            return t === a ? e.length && n.length ? w(e[0], n[0].row, n[0].column) : a : (C(e[0], n[0].row, n[0].column, t), R(e[0], n[0].row, "data", n[0].column), this)
            ...
            for (var e, n, a = $t.version.split("."), r = t.split("."), o = 0, i = r.length; o < i; o++)
            ...
            return n = n || !1, this.iterator("table", function(a) {
                ...
                f[g](), h[g](), !n && o && (o.insertBefore(s, a.nTableReinsertBefore), f.css("width", a.sDestroyWidth).removeClass(i.sTable), (r = a.asDestroyStripes.length) && d.children().each(function(e) {
        ...
        function() {
            var e = "ui-state-default",
                n = "css_right ui-icon ui-icon-",
                a = "fg-toolbar ui-toolbar ui-widget-header ui-helper-clearfix";
        ...
        pageButton: {
            _: function(e, a, r, o, i, s) {
                var l, u, c, f = e.oClasses,
                    ...
                    p = 0,
                    g = function(n, a) {
                        var o, c, b, v = function(t) {
                            ft(e, t.data.action, !0)
                        };
                        for (o = 0, c = a.length; o < c; o++)
                            if (b = a[o], t.isArray(b)) {
                                var S = t("<" + (b.DT_el || "div") + "/>").appendTo(n);
                                g(S, b)
                            } else {
                                switch (l = null, u = "", b) {
                                    case "ellipsis":
                                ...
                                null !== l && (Nt(t("<a>", {
                                    ...
                                    id: 0 === r && "string" == typeof b ? e.sTableId + "_" + b : null
                                }).html(l).appendTo(n), {
                                    action: b
                                }, v), p++)
                            }
